...
Console.WriteLine($"- {result.HandsWithPartnerSingleton} partners had a void in the 4-card suit ({result.HandsWithPartnerSingleton / (double)result.HandsPreempted * 100:F3}% of pre-empted hands)");
